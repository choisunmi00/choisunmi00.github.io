...
### 유용한 명령어
- `git status`: 현재 Git에서 무슨 일이 일어나고 있는지 보기
...
### VSCODE
<img src="assets/img/post/git/gitvscode.png" alt="1" width="100%" height="100%"/>
...
---
- `git merge` 명령어
    <img src="assets/img/post/git/merge.png" alt="1" width="100%" height="100%"/>
...
- `git rebase`: 브랜치의 시작점을 옮긴 뒤 fast-forward merge
    <img src="assets/img/post/git/rebase.png" alt="1" width="100%" height="100%"/>

    - 브랜치가 너무 많으면 log가 복잡하기 때문에 간단한 브랜치들은 rebase 통해 깔끔하게 관리
    - Conflict 발생 위험 높다

- `git merge --squash`: 새로운 브랜치의 커밋들을 합쳐 메인브랜치에 새로운 커밋으로 생성
    <img src="assets/img/post/git/squash.png" alt="1" width="100%" height="100%"/>
