...
- 세포 유형별 유전자 발현 데이터로부터 임계값 선택 및 분석
    ...
    - 임계값 설정
        - 전체 발현 데이터셋의 평균에서 표준편차(SD)의 2배를 뺀 값을 임계값으로 사용
...
<div style="width: 100%; height: 800px;">{% iframe https://nbviewer.org/gist/choisunmi00/208b307a30babd48734e833a7d598b1a 100% 100% %}</div>