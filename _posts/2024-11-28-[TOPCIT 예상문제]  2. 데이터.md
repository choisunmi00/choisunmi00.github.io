...
[02. 데이터 이해와 활용](https://www.topcit.or.kr/upload/edubox/essence/ess_ko_02/index.html)
...
<span style="color:#85a8b4"> 19.</span> 맵리듀스(MapReduce) (map 함수: 연관 데이터 분류 / reduce 함수: 중복 데이터 제거)   
